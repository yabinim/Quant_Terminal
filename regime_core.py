...
#      FMP 가 limit 을 무시해 기본 창 1254봉(≈5년)이 들어오면서 "52주 고점 대비"가
...
#   한계: 측정 구간(2022-06~2026-07)이 상승장 편중. 2018/2020 은 창 밖이라 미검증.
#     (당시 "FMP 5년 한도"로 적었으나 한도가 아니었다 — 창을 넓히면 재검증할 수 있다.)
# ──────────────────────────────────────────────────────────────────────────
